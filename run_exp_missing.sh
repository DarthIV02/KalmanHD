...
do
    ...
    do
        ...
        python3 main.py --dataset "$dataset" --learning_rate "$learning_rate" --hd_representation "$hd_representation" --p "$noise" --model KalmanHD --dimension_hd 1000;

        # python3 main.py --model DNN --dataset "$dataset" --p "$noise";
    done
done
